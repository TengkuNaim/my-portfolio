...
const App: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      title: "Portfolio",
      description:
        "A simple portfolio to showcase works, experiences and skills",
      technologies: ["React", "Tailwind", "TypeScript"],
      githubUrl: "https://github.com/TengkuNaim/my-portfolio",
      liveUrl: "https://tengkunaim.github.io/my-portfolio/",
      image:
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-12 max-w-2xl mx-auto animate-fade-in-delay-2">
                Passionate in creating functional, and user-friendly
                applications that solve real-world problems. Believe in clean
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
                    Software engineer by day, cafe conqueror by weekend
                    (P.S. it's been a while since my last one). I'm the kind of
                    person who writes clean, efficient code while sipping on my
                    third cup of coffee (caramel, obviously). A big fan of
                    Chelsea FC, team wins, and the thrill of chasing bugs and
                    bargains (seriously, hit me up if you spot any deals).
                  </p>
                  <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
                    I believe great tech doesn't have to be complicated—and
                    neither should getting freebies. Whether I'm hunting for coffee
                    or debugging a system, I bring curiosity, care, and just the
                    right amount of cheek. Let's build something solid (and
                    maybe grab a free coffee along the way)
                  </p>
